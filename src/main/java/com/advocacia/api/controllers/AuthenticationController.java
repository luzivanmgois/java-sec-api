...
import com.advocacia.api.domain.user.AuthenticationDTO;
import com.advocacia.api.domain.user.LoginResponseDTO;
import com.advocacia.api.domain.user.RegisterDTO;
